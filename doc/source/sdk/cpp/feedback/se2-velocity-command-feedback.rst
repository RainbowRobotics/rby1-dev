...
``rb::SE2VelocityCommandFeedback`` is the leaf feedback type for planar-base
velocity commands.
...
.. list-table::
   ...
   * - Kind
     - ``class``
   * - Primary role
     - Mark the leaf result for a planar-base velocity command.
...
.. doxygenclass:: rb::SE2VelocityCommandFeedback
   :project: rby1-sdk
   :members:
   :undoc-members:
